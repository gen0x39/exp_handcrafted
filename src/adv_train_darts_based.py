...
from model import HandcraftDARTSLikeNetworkCIFAR
...
parser.add_argument('--arch', type=str, default='CELL0', help='which architecture to use')
...
def main():
  ...
  model = HandcraftDARTSLikeNetworkCIFAR(args.init_channels, CIFAR_CLASSES, args.layers, args.auxiliary, genotype)
  model = model.cuda()
